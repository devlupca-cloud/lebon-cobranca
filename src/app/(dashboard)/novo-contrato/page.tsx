...
export default function NovoContratoPage() {
  ...
  const [selectedGuarantor, setSelectedGuarantor] = useState<CustomerAutocompleteItem | null>(null)
  ...
  if (!companyId) {
    return (
      <div className="p-6">
        <h1 className={pageTitle}>Novo Contrato de Confissão de Dívida</h1>
                ...
                {showAutocomplete && customerSearch.trim().length > 0 && (
                  <ul className="absolute z-10 mt-1 max-h-48 w-full overflow-auto rounded-[8px] border border-[#E0E3E7] bg-white py-1 shadow-lg" role="listbox">
                    {customerOptions.length === 0 ? (
                      <li className="px-4 py-2 text-sm text-[#57636C]">Nenhum cliente encontrado</li>
                    ) : (
